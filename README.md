...
[![Netlify Status](https://api.netlify.com/api/v1/badges/6ed4a252-c7cb-4375-aafb-316e886a0bfd/deploy-status)](https://app.netlify.com/sites/dino-rsa/deploys)
...
A aplicação web disposta neste repositório foi desenvolvida sob a [licença MIT](./LICENSE).
